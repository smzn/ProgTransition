...
if __name__ == '__main__':
    ...
    calmonth = sys.argv[1]
    filepath = path+'/main/'+calmonth
    tfilename = 'transition_all_'+calmonth+'.csv'
    dfilename = 'duration_all_'+calmonth+'.csv'
    APfile = path+'/after/APlocations_group.csv'
    aftertransition = AfterTransition(filepath, APfile, path, calmonth)
